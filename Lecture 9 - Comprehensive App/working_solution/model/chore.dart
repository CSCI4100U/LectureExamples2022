class Chore{
  ...
  Chore(
      {this.id, this.name, this.icon, this.assignedTo, this.date, this.time, this.repeat}){
        this.sunday = 0;
        this.monday = 0;
        this.tuesday = 0;
        this.wednesday = 0;
  ...
  Chore.fromMap(Map<String, dynamic> map){
    ...
    this.saturday = map.containsKey('saturdary') ? map['saturday'] : 0;
  }
  ...
  String toString(){
    ...
    return 'Chore(id: $id, name: $name, assignedTo: $assignedTo, icon: $icon, repeat: $repeat, date: $date, time: $time, weekdays: $weekdaySummary';
  }
}